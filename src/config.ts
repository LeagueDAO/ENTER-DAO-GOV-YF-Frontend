...
const config = {
  ...
  tokens: {
    ...
    ionx: toLowerCase(process.env.REACT_APP_TOKEN_IONX_ADDR),
    ...
    usdcLeagSLP: toLowerCase(process.env.REACT_APP_TOKEN_USDC_LEAG_SUSHI_LP),
  },
  contracts: {
    yf: {
      staking: toLowerCase(process.env.REACT_APP_CONTRACT_YF_STAKING_ADDR),
      entr: toLowerCase(process.env.REACT_APP_CONTRACT_YF_ENTR_ADDR),
      ionx: toLowerCase(process.env.REACT_APP_CONTRACT_YF_IONX_ADDR),
      ...
      usdcLeagSLP: toLowerCase(process.env.REACT_APP_CONTRACT_YF_USDC_LEAG_SUSHI_LP),
    },
    dao: {
