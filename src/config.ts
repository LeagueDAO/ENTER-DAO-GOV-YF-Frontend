...
const config = {
  ...
  tokens: {
    ...
    xyz: toLowerCase(process.env.REACT_APP_TOKEN_SUSHI_ADDR),
    bond: toLowerCase(process.env.REACT_APP_TOKEN_BOND_ADDR),
    aave: toLowerCase(process.env.REACT_APP_TOKEN_AAVE_ADDR),
    ionx: toLowerCase(process.env.REACT_APP_TOKEN_SUSHI_ADDR),
    entr: toLowerCase(process.env.REACT_APP_TOKEN_SUSHI_ADDR),
  ...
  contracts: {
    yf: {
      ...
      xyz: toLowerCase(process.env.REACT_APP_CONTRACT_YF_SUSHI_ADDR),
      ionx: toLowerCase(process.env.REACT_APP_CONTRACT_YF_SUSHI_ADDR),
      entr: toLowerCase(process.env.REACT_APP_CONTRACT_YF_SUSHI_ADDR),
