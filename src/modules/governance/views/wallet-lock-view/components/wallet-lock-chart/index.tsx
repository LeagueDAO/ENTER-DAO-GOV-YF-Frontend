...
import { formatBigValue, formatLeagValue } from 'web3/utils';
      ...
      <div className="card-header">
        <Hint
          text={
            <>
              <Text type="p2">
                The multiplier mechanic allows users to lock ${LeagueToken.symbol} for a period up to 1 year and get a
                bonus of up to 2x v{LeagueToken.symbol}. The bonus is linear, as per the following example:
              </Text>
              <ul>
                <li>
                  <Text type="p2">
                    lock 1000 ${LeagueToken.symbol} for 1 year → get back 2000 v{LeagueToken.symbol}
                  </Text>
                </li>
                <li>
                  <Text type="p2">
                    lock 1000 ${LeagueToken.symbol} for 6 months → get back 1500 v{LeagueToken.symbol}
                  </Text>
                </li>
              </ul>
          ...
          <Text type="small" weight="semibold">
            {formatLeagValue(myBonus)}
            <span> v{LeagueToken.symbol} bonus - </span>
