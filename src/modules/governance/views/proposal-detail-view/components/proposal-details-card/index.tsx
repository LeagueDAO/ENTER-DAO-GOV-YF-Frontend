  ...
  return (
    <div className="card">
      ...
      <div className="flexbox-list p-24" style={{ '--gap': '32px' } as React.CSSProperties}>
        ...
        <div>
          <Hint
            text={`If the creator’s v${LeagueToken.symbol} balance falls below ${minThreshold}% of the total amount of $${LeagueToken.symbol} staked in the DAO the proposal can be cancelled by anyone.`}>
            <Text type="small" weight="semibold" color="secondary" className="mb-4">
              Creator threshold
            </Text>
          </Hint>
