    ...
    <Modal width={832} {...modalProps}>
      <div className="flex flow-row">
        <div className="flex flow-row mb-32">
          <Text type="h2" weight="semibold" color="primary" className={cn('mb-8', s.claimTitle)} font="secondary">
            Claim your reward
          </Text>
        ...
        <Grid flow="row" gap={24} className={s.grid}>
          {yfPoolsCtx.yfPools.map(yfPool => (
            <PoolHarvestButton
              ...
              icons={yfPool.icons}
              label={yfPool.label}
              reward={yfPool.contract.toClaim?.unscaleBy(LeagueToken.decimals)}
